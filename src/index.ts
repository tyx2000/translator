...
const PROMPT_VERSION = "plain-dictionary-v5";
...
function buildSystemPrompt(): string {
  return [
    ...
    "For each important part of speech, include a concise meaning, one natural medium-length to long example sentence in the source language, and the translation of that example sentence.",
